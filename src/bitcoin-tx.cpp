...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " fokawa-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  fokawa-tx [options] <hex-tx> [commands]  Update hex-encoded fokawa transaction\n" +
            "or:     fokawa-tx [options] -create [commands]   Create hex-encoded fokawa transaction\n" +
            "\n";

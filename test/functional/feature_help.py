...
"""Verify that starting fokawa with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fokawa with -h for help text")
        ...
        self.log.info("Start fokawa with -version for version information")
        ...
        self.log.info("Start fokawad with -fakearg to make sure it does not start")

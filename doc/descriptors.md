# Support for Output Descriptors in Fokawa Core

Since Fokawa Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `fkw1...` for mainnet or `tfkw1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Fokawa's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Fokawa Core wallets, a convenience function `combo` is

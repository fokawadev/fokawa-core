...
bech32_templates = [
  ...
  ('fkw',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('fkw',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('fkw',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tfkw',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tfkw',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tfkw',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rfkw',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rfkw',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rfkw', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tfkw',  17, 32, False, False, False),
  ('rfkw',  3,  1, False, False, False),
  ('fkw',   15, 41, False, False, False),
  ('tfkw',  0, 16, False, False, False),
  ('rfkw',  0, 32, True,  False, False),
  ('fkw',   0, 16, True,  False, False),
  ('tfkw',  0, 32, False, True,  False),
  ('rfkw',  0, 20, False, False, True)
]
